...
namespace TakeItToTheBank.Tests.AccountTests
{
    ...
    public class SavingAccountTests
    {
        ...
        {
            // Arrange
            var account = new SavingAccount("Tom", 200);
        ...
        {
            // Arrange
            var account = new SavingAccount("Janice", 300);
        ...
        [TestMethod]
        public void Withdraw_WhenAmountToWithdrawIsGreaterThanAccountBalance_ShouldThrowBalanceTooLowToWithdrawException()
        {
            // Arrange
            var account = new SavingAccount("Tom", 100);
        ...
        {
            // Arrange
            var accountToTransferFrom = new SavingAccount("Tom", 300);
            var accountToTransferTo = new SavingAccount("Janice", 300);
        ...
        [TestMethod]
        public void Transfer_WhenAmountToTransferIsGreaterThanAccountBalance_ShouldThrowBalanceTooLowToTransferException()
        {
            // Arrange
            var accountToTransferFrom = new SavingAccount("Tom", 300);
            var accountToTransferTo = new SavingAccount("Janice", 300);
